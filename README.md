...
<h3 align="center">AI/ML Developer focused on building real-world ML & GenAI systems</h3>
...
- 🧠 ML models for prediction (classification & regression)  
- 🤖 GenAI apps (RAG, summarization, Q&A systems)  
- 📊 Data-driven applications with real-world use cases  

---

## 🎯 Goals

- Become **internship/job-ready for AI/ML roles in next few months**  
- Build **high-quality, production-like ML/GenAI projects**  
- Transition into **SDE/ML Engineer role with strong fundamentals**  
